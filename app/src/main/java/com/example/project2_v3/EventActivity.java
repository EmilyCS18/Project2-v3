...
public class EventActivity extends AppCompatActivity {
    ...
    private void saveLocationData() {
        ...
        float tollFee = Float.parseFloat(((EditText) findViewById(R.id.toll_Fee_EditText)).getText().toString());
        float parkingFee = Float.parseFloat(((EditText) findViewById(R.id.parking_Fee_EditText)).getText().toString());
